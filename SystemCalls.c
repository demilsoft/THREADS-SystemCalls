...
static void system_call_handler(system_call_arguments_t* args)
{
    ...
    case SYS_SPAWN:
        pFunctionName = "Spawn";
        args->arguments[0] = (void*)(intptr_t)sys_spawn((char*)args->arguments[4], // name
            (int (*)(char*))args->arguments[0],  // start function
            (char*)args->arguments[1],           // arguments
            (intptr_t)args->arguments[2],        // stack size
            (intptr_t)args->arguments[3]);       // priority
        args->arguments[3] = (void*)(intptr_t)((intptr_t)args->arguments[0] >= 0 ? 0 : -1);
        break;
    case SYS_WAIT:
        pFunctionName = "Wait";
        args->arguments[0] = (void*)(intptr_t)wait_real((int*)&args->arguments[1]);
        args->arguments[3] = (void*)(intptr_t)((intptr_t)args->arguments[0] >= 0 ? 0 : -1);
        break;
    case SYS_EXIT:
        pFunctionName = "Exit";
        Exit_real((intptr_t)args->arguments[0]);
        break;
    case SYS_SEMCREATE:
        pFunctionName = "SemCreate";
        args->arguments[0] = (void*)(intptr_t)k_semcreate((intptr_t)args->arguments[0]);
        args->arguments[3] = (void*)(intptr_t)((intptr_t)args->arguments[0] >= 0 ? 0 : -1);
        break;
    case SYS_SEMFREE:
        pFunctionName = "SemFree";
        args->arguments[3] = (void*)(intptr_t)k_semfree((intptr_t)args->arguments[0]);
        break;
    case SYS_SEMV:
        pFunctionName = "SemV";
        args->arguments[3] = (void*)(intptr_t)k_semv((intptr_t)args->arguments[0]);
        break;
    case SYS_SEMP:
        args->arguments[3] = (void*)(intptr_t)k_semp((intptr_t)args->arguments[0]);
        pFunctionName = "SemP";
        break;
    case SYS_GETPID:
